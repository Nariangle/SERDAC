...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    try {
      ...
      $mail->Body = 'Greetings! We have received a request to reset your password. If you did not initiate this password reset request, please ignore this email.<br><br>'
                . '<a href="http://wmsuserdac.online/changepassword.php?reset='.$code.'" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: #FFFFFF; text-decoration: none; border-radius: 5px;">Change Password</a>';
      ...
      echo 'Message has been sent';
        ...
        echo 'swal("Success!", "We have sent a reset link to your email. Your account has been temporarily locked. To unlock, please check your email (including your primary, important, and spam folders) to proceed with resetting your password.", "success").then(function() { window.location = "forgotpassword.php"; });';
        echo '</script>';

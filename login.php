...
<body  style="background-image: url(assets/img/adminbg.png);  background-size: 100%">
  ...
  <form class="login-form" action="login.php" method="post">
    ...
    <a href="admin-1/Admin.php"> <img src="assets/img/serdac.ico"  alt="" width="150" height="150" class="d-inline-block align-text-top">
    </a>
      <br>
      <span id="zk-trigger"><span id="hide1" class="hide">WMSU-SATELLITE SERDAC</span>
      ...
      if ($user_data['code'] == '') {
        if ($user_data['status'] == 'active') { // Check if account is active
          if ($user_data['password'] === $password) {
           ...
           echo '<script type="text/javascript">';
           echo 'swal("Error!", "Your account has not been verified yet. Please check your email (including your primary, important, and spam folders) to verify your email address.", "error").then(function() { window.location = "login.php"; });';
           echo '</script>';
           exit;
            ...
            echo '<script type="text/javascript">';
            echo 'swal("Error!", "You don\'t have an account", "error").then(function() { window.location = "login.php"; });';
            echo '</script>';
            exit;
          }
        }
